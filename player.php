...
<body>
    <?php
    session_start();
     $_SESSION["name"]=$_POST["txtbox"];
     $conn=mysqli_connect("localhost","root","","valstat");
     $sql="select * from player_info where Game_Name='".$_SESSION['name']."';";
    ...
    <div class="parent">
        <div class="achild">
            ...
            <div class="CRating"> 
                ...
                <div class="flexrating">
                    ...
                    $_SESSION['tpeak']=$row['Peak_Rating'];
                    ?>
                    </p>
                 </div>
            </div>
        ...
        <div class="bchild">
            ...
            <div class="overview">
             ...
             <p style="font-size: 30px;padding-bottom: 10px;color: white;">Match History:</p>
            <div class="history">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        1 </td>
                        <td><?php
                        $sql="select Agent_played from matches where Srno=1;";
                        $result=$conn->query($sql);
                        $row= mysqli_fetch_assoc($result);
                        ...
                        <td>
                            <?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select Gamemode from matches where Srno=1;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['Gamemode'];
                            ?> 
                        ...
                        <td><?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select Map from matches where Srno=1;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['Map'];
                            ?> </td>
                        ...
                        <?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select Score from matches where Srno=1;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                        ...
                        <td><?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select KDR from matches where Srno=1;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['KDR'];
                            ?></td>
                        <td><?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select ACS from matches where Srno=1;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['ACS'];
                            ?></td>
                    ...
                    <tr>
                        <td>2</td>
                        <td><?php
                        $sql="select Agent_played from matches where Srno=2;";
                        $result=$conn->query($sql);
                        $row= mysqli_fetch_assoc($result);
                        if(strcmp($row['Agent_played'],"Sage")==0)
                        {
                        ...
                        <td>
                            <?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select Gamemode from matches where Srno=2;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['Gamemode'];
                            ?> 
                        ...
                        <td><?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select Map from matches where Srno=2;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['Map'];
                            ?> </td>
                        ...
                        <?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select Score from matches where Srno=2;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['Score'],":",$row['Score']+12;
                            ?> 
                        </td>
                        <td><?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select KDR from matches where Srno=2;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['KDR'];
                            ?></td>
                        <td><?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select ACS from matches where Srno=2;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['ACS'];
                            ?></td>
                    ...
                    <tr>
                        <td>3</td>
                        <td><?php
                        $sql="select Agent_played from matches where Srno=3;";
                        $result=$conn->query($sql);
                        $row= mysqli_fetch_assoc($result);
                        if(strcmp($row['Agent_played'],"Sage")==0)
                        {
                        ...
                        <td>
                            ...
                            $sql="select Gamemode from matches where Srno=3;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['Gamemode'];
                            ?> 
                        ...
                        <td><?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select Map from matches where Srno=3;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['Map'];
                            ?> </td>
                        ...
                        <?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select Score from matches where Srno=3;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['Score'],":",$row['Score']-2;
                            ?> 
                        ...
                        <td><?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select KDR from matches where Srno=3;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['KDR'];
                            ?></td>
                        <td><?php
                            $conn=mysqli_connect("localhost","root","","valstat");
                            $sql="select ACS from matches where Srno=3;";
                            $result=$conn->query($sql);
                            $row= mysqli_fetch_assoc($result);
                            echo $row['ACS'];
                            ?></td>
