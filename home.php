    ...
    <div class="background">
        ...
        <header>
            ...
            <form action="player.php" method="post">
                <div class="searchbo">
                <input type="search" class="searchbox" name ="txtbox" placeholder="Search Player Information" >
                </div>
                <div class="details">   
                </div>
                <div class="dbut"> 
        ...
        <section class="about">
            ...
            <div class="main1">
                ...
                <div class="about-text1">
                    ...
                    <p>This is Subroto Santra, an ardent and experienced front-end developer. With over two years of experience in HTML, CSS, and javascript coding through courses and practical projects, I proudly flaunt a thorough knowledge of the subject. Through this project I expect to hone my talents and become a professional coder.
            ...
            <div class="main2">
                ...
                <div class="about-text2">
                    <p>Myself, Om Basak, am a enthusiastic backend developer with a string sense of database connectivity technicalities. I am currently in the penultimate year of my studies at CHRIST (Deemed to be University), Bangalore. I aspire to learn in detail about the topic through this project.
            ...
            <div class="main3">
                ...
                <div class="about-text3">
                    <p>A curious coder and adaptable teammate, myself Lisa Shibu George, am in the second year of studying Bachelors in Computer application. With course knowledge in front-end coding and experience in working with back end, I work with the team to learn more.
                    </p>
